    ...
    <div class="container">
        <div class="profile">
            <div class="profile-image">
                ...
                <img src=<?php echo "edit_profile/profile_pics/" . $pfp . "" ?> alt="">
                <?php } else { ?>
            ...
            <div class="profile-user-settings">
                ...
                <button class="btn profile-edit-btn" onClick="document.location.href='https://phpstagram.000webhostapp.com/profile/edit_profile/editForm.php'">Edit Profile</button>
